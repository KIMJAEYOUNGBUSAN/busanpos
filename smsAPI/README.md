...
발송사 키는 코드에 넣지 말고 환경변수로 주입합니다.

```bash
set SOLAPI_API_KEY=your-solapi-api-key
set SOLAPI_API_SECRET=your-solapi-api-secret
set SOLAPI_DEFAULT_FROM=0212345678
set SOLAPI_ENABLED=false
set SOLAPI_TEST_MODE=true
set RESEND_API_KEY=your-resend-api-key
set RESEND_DEFAULT_FROM=noreply@example.com
set RESEND_ENABLED=false
set RESEND_TEST_MODE=true
```

실제 발송을 시작할 때만 `*_ENABLED=true`, `*_TEST_MODE=false`로 바꿉니다.
